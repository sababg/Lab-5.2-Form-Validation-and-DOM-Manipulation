...
5: I checked all the inputs with the help of eventListener, so they will be checked any time the user touches the inputs and checked almost all the conditions in it, then shows custom error message for each error separately. Also, check the errors in the submission.
